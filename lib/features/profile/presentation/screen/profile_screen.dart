...
class ProfileScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create:
          (context) => UserProfileCubit(ProfileRepository())..fetchProfile(),
      child: Scaffold(
                      ...
                      children: [
                          ...
                          child: ValueListenableBuilder(
                            ...
                            builder: (_, mode, __) {
                              ...
                              return SwitchListTile(
                                value: isDark,
                                activeColor:
                                    isDarkMode ? colorScheme.surfaceTint : null,
                                activeTrackColor:
                                    isDarkMode
                                        ? colorScheme.surfaceTint.withOpacity(
                                          0.3,
                                        )
                                        : null,
                                inactiveThumbColor:
                                    isDarkMode ? Color(0xFFA19086) : null,
                                inactiveTrackColor:
                                    isDarkMode ? Color(0xFF6A524D) : null,
                        ...
                        Padding(
                          ...
                          child: ValueListenableBuilder(
                            ...
                            builder: (context, logoutNotifierValue, child) {
                              return SwitchListTile(
                                title: Text(
                                  "Logout",
                                  style: theme.textTheme.bodyMedium,
